...
class PyParameter {
 public:
  ...
  PyParameter(Parameter* param) { parameter_.reset(param); }
  ~PyParameter() {}

  // PyParameter(const std::string& name, const bool bool_value) {
  //   std::make_shared<Parameter>(name, bool_value);
  // }
  ...
  // PyParameter(const std::string& name, const google::protobuf::Message& msg);
